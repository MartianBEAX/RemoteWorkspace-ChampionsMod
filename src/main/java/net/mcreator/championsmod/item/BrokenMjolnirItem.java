...
import net.mcreator.championsmod.procedures.BrokenMjolnirRightclickProcedure;
import net.mcreator.championsmod.procedures.BrokenMjolnirInInventoryProcedure;
import net.mcreator.championsmod.procedures.BrokenMjolnirEntityIsHitProcedure;
...
public class BrokenMjolnirItem extends ChampionsModModElements.ModElement {
	@ObjectHolder("champions_mod:broken_mjolnir")
	public static final Item block = null;

	public BrokenMjolnirItem(ChampionsModModElements instance) {
		super(instance, 19);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				BrokenMjolnirRightclickProcedure
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				BrokenMjolnirEntityIsHitProcedure.executeProcedure(Stream
		...
		}.setRegistryName("broken_mjolnir"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(ItemGroup.COMBAT).maxDamage(9736).isImmuneToFire());
		}
