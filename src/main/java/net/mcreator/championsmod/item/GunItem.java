...
import net.mcreator.championsmod.procedures.GunRightclickedProcedure;
...
public class GunItem extends ChampionsModModElements.ModElement {
	@ObjectHolder("champions_mod:gun")
	public static final Item block = null;

	public GunItem(ChampionsModModElements instance) {
		super(instance, 26);
	}
